...
// import { useTheme } from "next-themes" // Removing next-themes as it might not be set up, using simple check or default
...
export function SaveButton({
    ...
    const isDark = true // Defaulting to dark mode as per the app's aesthetic
    ...
    return (
        <div className="relative">
            <motion.button
                ...
                type="submit" // Added type submit to work in form
            >
                {status === "idle" && (
                    <span>
                        <span
